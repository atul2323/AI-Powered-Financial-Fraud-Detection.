...
merchant_category = st.selectbox(
    "Merchant Category",
    ["Food", "Travel", "Electronics", "Clothing", "Grocery"]
)
...
device_risk_score = round(random.uniform(0, 1), 2)
ip_risk_score = round(random.uniform(0, 1), 2)

st.info(f"Device Risk Score: {device_risk_score}")
st.info(f"IP Risk Score: {ip_risk_score}")
